...
export function ConfigImprovementContent() {
  ...
  const fetchConfigDetail = useCallback(async (configId: string) => {
    ...
    try {
      ...
      toast({
        ...
        title: "Error",
        description:
          err instanceof Error ? (err as BackendError).detail || err.message : "Failed to fetch configuration details",
      })
    } finally {
      setIsLoadingConfig(false)
    }
}, [router, toast]) // Add dependencies used in the callback
  ...
  const fetchConfigurations = useCallback(async () => {
    ...
    try {
      ...
      toast({
        ...
        title: "Error",
        description:
          err instanceof Error ? (err as BackendError).detail || err.message : "Failed to fetch configurations",
      })
    } finally {
      setIsLoadingConfigs(false)
    }
}, [router, searchParams, toast, fetchConfigDetail]) // Added fetchConfigDetail to dependencies
  ...
  const submitImprovement = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          err instanceof Error ? (err as BackendError).detail || err.message : "Failed to improve configuration",
      })
    } finally {
