...
import { useState, useEffect } from "react" // Add Suspense
...
export default function NotFound() {
  ...
  // Move media queries to useEffect
  useEffect(() => {
                        ...
                        {isLoaded && !prefersReducedMotion && (
                            <div className="relative h-64 mb-6">
                                ...
                                {[...Array(12)].map((_, i) => (
                                    ...
                                    >
                                        <div
                                            className={`rounded-full bg-white/80 ${i % 3 === 0 ? "w-4 h-4" : i % 2 === 0 ? "w-3 h-3" : "w-2 h-2"
                                                }`}
                                        />
                                    </motion.div>
                                ))}
